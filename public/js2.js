/*1597377448,,JIT Construction: v1002513418,en_US*/
/**
...
try {
          ...
          with(this) {
              ...
              __d("sdk.DOM", ["guid", "sdk.domReady"], (function(a, b, c, d, e, f) {
                  ...
                  function f(a, b) {
                      if (a == null) return;
                      b = new RegExp("\\s*" + b, "g");
                      a.className = ES(a.className.replace(b, ""), "trim", !0)
                  }
                  ...
                  function n(a, b, c, d, e) {
                      ...
                      for (var f = 0; f < a.length; f++)
                          if (ES(a[f].ownerNode.title, "contains", !0, b)) {
                              var g = a[f];
                  ...
                  function o(a, c, d) {
                      var e;
                      d != null && d.nodeType === 11 ? d.id != null && h[d.id] != null ? e = h[d.id] : (d.id == null && (d.id = b("guid")()), e = {}, h[d.id] = e) : e = g;
                      var f = !0;
                      ...
                      j.type = "text/css";
                      j.textContent = a;
                      j.title = ES(c.reduce(function(a, b) {
                          return a + b + " "
                      }), "trim", !0);
                  ...
                  function u(a) {
                      ...
                      var b = a.match(s);
                      b && ES(t, "indexOf", !0, b[1]) !== -1 && (a = "-" + a);
                      return a
                  }
                  d = {
                      addCss: d,
                      addCssRules: o,
                      updateOrAddCssRule: n,
                      containsCss: j,
                      getAttr: i,
                      getBoolAttr: a,
                      getByClass: k,
              ...
              __d("invariant", ["Env", "TAALOpcodes", "sprintf"], (function(a, b, c, d, e, f) {
                  ...
                  function a(a, c) {
                      if (!a) {
                          ...
                          n.messageFormat = d;
                          n.messageParams = ES(f, "map", !0, function(a) {
                              return String(a)
                          });
              ...
              __d("FB", ["DOMWrapper", "GlobalCallback", "JSSDKCssConfig", "Log", "dotAccess", "sdk.Content", "sdk.DOM", "sdk.domReady", "sdk.ErrorHandling"], (function(a, b, c, d, e, f) {
                  var g = window.FB = {};
                  c = {};
                  b("Log").level = 0;
              ...
              __d("ErrorSerializer", ["ErrorMetadata"], (function(a, b, c, d, e, f) {
                  ...
                  function h(a) {
                      try {
                          ...
                          d && d.length > 0 && (e.params = ES(d, "map", !0, function(a) {
                              return String(a)
                          }));
                          return e
                      } catch (b) {
              ...
              __d("UriNeedRawQuerySVChecker", ["PHPQuerySerializer", "URIBase", "UriNeedRawQuerySVConfig"], (function(a, b, c, d, e, f) {
                  ...
                  function j(a) {
                      return a != null && ES(b("UriNeedRawQuerySVConfig").uris, "some", !0, function(c) {
              ...
              __d("sdk.api", ["ApiClient", "sdk.feature", "sdk.PlatformVersioning", "sdk.Runtime", "sdk.Scribe", "sdk.URI", "sdk.warnInsecure"], (function(a, b, c, d, e, f) {
                  ...
                  (c = b("ApiClient")).setDefaultParams({
                      sdk: "joey"
                  });
              ...
              __d("insertIframe", ["GlobalCallback", "getBlankIframeSrc", "guid"], (function(a, b, c, d, e, f) {
                  function a(a) {
                      var c = a.id != null ? a.id : b("guid")(),
                          ...
                          f = !1,
                          g = function() {
                              e && !f && (f = !0, typeof a.onload === "function" && a.onload(a.root.firstChild))
                          },
                      ...
                      if (document.attachEvent) {
                          ...
                          e = !0;
                          window.setTimeout(function() {
                              a.root.innerHTML = i, a.root.firstChild.src = a.url, typeof a.onInsert === "function" && a.onInsert(a.root.firstChild)
                          }, 0)
                      } else {
              ...
              __d("sdk.Impressions", ["Miny", "QueryString", "UrlMap", "getBlankIframeSrc", "guid", "insertIframe", "sdk.Content", "sdk.Runtime"], (function(a, b, c, d, e, f) {
                  ...
                  function h(a, c, d) {
                      if (c.length <= 2e3) {
                          ...
                          e = b("guid")();
                          var f = b("sdk.Content").appendHidden(document.createElement("div"));
                          b("insertIframe")({
              ...
              __d("sdk.Auth", ["Log", "ObservableMixin", "QueryString", "UrlMap", "sdk.Cookie", "sdk.feature", "sdk.getContextType", "sdk.Impressions", "sdk.Runtime", "sdk.Scribe", "sdk.SignedRequest", "sdk.UA", "sdk.URI", "sdk.WebStorage"], (function(a, b, c, d, e, f) {
                  var g = "fblst_",
                      h = "fbssls_",
                      i = "fblo_",
                      j = 365 * 24 * 60 * 60 * 1e3,
                  ...
                  b("sdk.Runtime").subscribe("AccessToken.change", function(a) {
                      !a && b("sdk.Runtime").getLoginStatus() === "connected" && p.getLoginStatus(null, !0)
                  });
                  ...
                  function q(a, c, d) {
                      ...
                      } else b("sdk.Runtime").getUseCookie() && b("sdk.Cookie").clearSignedRequestCookie(), b("sdk.Runtime").getUseLocalStorage() && w();
                  ...
                  function s(a) {
                      b("sdk.Runtime").getUseCookie() && (b("sdk.Cookie").getDomain() == null && b("sdk.Cookie").setDomain("." + a))
                  }
                  ...
                  function a(c) {
                      ...
                      if (a != null && a.accessToken != null) {
                          ...
                          var d = new XMLHttpRequest();
                          d && (d.open("GET", a.toString(), !0), d.withCredentials = !0, c && (d.onreadystatechange = function() {
                              d.readyState >= 2 && c({
                                  authResponse: r(),
                  ...
                  function c(a, c, d, e) {
                      return function(d) {
                          if (d && d.access_token) {
                              ...
                              d.asset_scopes && (c = babelHelpers["extends"]({}, c, {
                              ...
                              q(c, f);
                              u(e)
                          } else d && d.asset_scopes ? (c = {
                              asset_scopes: ES("JSON", "parse", !1, d.asset_scopes)
                          }, c = v(c, d), x(), f = "connected", q(c, f), u(e)) : d && d.error === "access_denied" ? (y(), f = "unknown", q(null, f)) : d && d.result && (x(), c = d.result.authResponse); if (a) {
                              f = {
                                  authResponse: c,
                                  status: b("sdk.Runtime").getLoginStatus()
                              };
                  ...
                  function u(a) {
                      ...
                      c = {
                          ...
                          logger_id: c,
                          client_funnel_version: b("sdk.feature")("oauth_funnel_logger_version", 1),
                          cbt_delta: ES("Date", "now", !1) - a
                      };
                      b("sdk.Impressions").log(117, {
                          payload: c
                      })
                  }
                  ...
                  function v(a, c) {
                      ...
                      c.referred && (a = babelHelpers["extends"]({}, a, {
                          referred: c.referred
                      }));
                  ...
                  function A(a, c) {
                      ...
                      window.removeEventListener("fbNativeLoginResponse", function(b) {
                          return A(a, b.response)
                      })
                  }
                  ...
                  function B(a) {
                      ...
                      if (b("sdk.Runtime").getLoginStatus() !== "connected" && (document.referrer === "" || /^https?:\/\/([\w\.]+)?facebook.com\/?/.test(document.referrer))) {
                          ...
                          if (f !== "") {
                              ...
                              if (window == top && d != null) {
                                  ...
                                  a = function(a) {
                                      var c;
                                      a != null && a.status === "connected" && ((c = a.authResponse) == null ? void 0 : c.accessToken) === d && (delete h.access_token, delete h.code, delete h.signed_request, location.hash = b("QueryString").encode(h));
                                      j != null && j(a)
                                  }
                              }
                          }
                      ...
                      if (b("sdk.UA").isSupportedIABVersion(parseFloat(b("sdk.feature")("iab_login_android_support_version", "999.0"))) && window.FBLogin && typeof window.FBLogin.showFBLoginBottomSheetInIAB === "function" && b("sdk.feature")("iab_login_status", !1)) {
                          ...
                          window.addEventListener("fbNativeLoginFallbackResponse", function(b) {
                              p.getLoginStatusCORS(a, k, n)
                          });
                          c = b("sdk.Runtime").getClientID();
                          window.FBLogin.showFBLoginBottomSheetInIAB(c)
                      } else p.getLoginStatusCORS(a, k, n)
                  }
                  ...
                  function D(a, c, d) {
                      switch (c) {
                          case "connected":
                              ...
                              t(d.graph_domain);
                              if (b("sdk.Runtime").getUseLocalStorage() && location.protocol === "https:" && d.long_lived_token) {
                  ...
                  function d(c, d, a) {
                      ...
                      function g() {
                          ...
                          d && (d.open("GET", f.toString(), !0), d.withCredentials = !0, d.onreadystatechange = function() {
                              if (d.readyState === 4) {
                                  ...
                                  if (d.status === 200) {
                                      D(c, (f = d.getResponseHeader("fb-s")) != null ? f : "unknown", (f = d.getResponseHeader("fb-ar")) != null ? f : "{}")
                                  } else E(c, d.status, a)
                              }
                          }, d.send())
                      }
                      ...
                      function h() {
                          window.fetch(f.toString(), {
                              ...
                              if (b.status === 200) {
                                  var d;
                                  D(c, (d = b.headers.get("fb-s")) != null ? d : "unknown", (d = b.headers.get("fb-ar")) != null ? d : "{}")
                              } else E(c, b.status, a)
                          })["catch"](function(b) {
                              return E(c, 0, a)
                          })
                  ...
                  function f(a, c) {
                      ...
                      F = "loading";
                      d = function(a) {
                          F = "loaded", p.inform("FB.loginStatus", a), p.clearSubscribers("FB.loginStatus")
                      };
                      B(d)
                  }
                  ...
                  a = {
                      ...
                      addDoubleClickAction: function(a, c, d) {
                          ...
                          return b("DOMEventListener").add(a, "click", function() {
                              e !== null && (window.clearTimeout(e), e = null, c()), e = window.setTimeout(function() {
                                  e = null
                              }, d)
                          })
                      },
                      addIdleDesktopAction: function(a, c, d) {
                          ...
                          return b("DOMEventListener").add(a, "mouseenter", function() {
                              window.clearTimeout(e), f || (f = b("DOMEventListener").add(a, "mouseleave", function() {
                                  g()
                              }))
                          })
                      },
                  ...
                  var m = b("Type").extend({
                      ...
                      n = {
                          ...
                          _setDialogOverlayStyle: function() {
                              n._overlayEl != null && b("sdk.DialogUtils").applyScreenDimensions(n._overlayEl)
                          },
                          ...
                          _hideTabletOverlay: function() {
                              n.isTabletStyle() && (n._overlayEl != null && (n._overlayEl.className = "hidden"), ES(n._overlayListeners, "forEach", !0, function(a) {
                                  return a.remove()
                              }), n._overlayListeners = [])
                          },
                          showLoader: function(a, c) {
                              a || (a = function() {});
                              var d = function() {
                                  n._hideLoader(), b("sdk.DialogUtils").onDialogHideCleanup(n.isTabletStyle()), n._hideTabletOverlay(), a != null && a()
                              };
                          ...
                          getDefaultSize: function() {
                              if (b("sdk.UA").mobile()) {
                                  ...
                                  if (a) {
                                      var c;
                                      if ((c = (c = b("sdk.DOM").getViewportInfo()) == null ? void 0 : c.width) != null ? c : i <= a.width) {
                                          a.width = (c = (c = b("sdk.DOM").getViewportInfo()) == null ? void 0 : c.width) != null ? c : i - g
                                      }
                                      if ((c = (c = b("sdk.DOM").getViewportInfo()) == null ? void 0 : c.height) != null ? c : h <= a.height) {
                                          a.height = (c = (c = b("sdk.DOM").getViewportInfo()) == null ? void 0 : c.height) != null ? c : h - g
                                      }
                                      return a
                                  }
              ...
              __d("sdk.XD", ["JSSDKXDConfig", "Log", "QueryString", "Queue", "UrlMap", "guid", "isFacebookURI", "resolveWindow", "sdk.Event", "sdk.feature", "sdk.RPC", "sdk.Runtime", "sdk.Scribe", "sdk.URI"], (function(a, b, c, d, e, f) {
                              ...
                              if (typeof a.name === "string") {
                                  ...
                                  if (j.test(c)) {
                                      ...
                                      e.start(function(a) {
                                          ...
                                          window.frames[d] != null ? window.frames[d].postMessage({
                                              xdArbiterHandleMessage: !0,
                                              message: a,
                                              origin: m
                                          }, c) : b("Log").info("Message discarded for plugin at window.frames[%s] which may have been removed by a new XFBML.parse() call.", d)
                                      })
                                  } else {
                  ...
                  function s(a, c) {
                      a == "facebook" ? (c.relation = h, g.enqueue(c), !b("sdk.Runtime").isCanvasEnvironment() && !g.isStarted() && u(i)) : b("Queue").get(a, {}).enqueue(c)
                  }
                  ...
                  function u(a) {
                      ...
                      if (window.parent != top) {
                          b("Log").warn("cannot deliver messages to facebook unless window.parent is top and facebook.com.");
                          return
                      }
              ...
              __d("sdk.UIServer", ["Log", "QueryString", "UrlMap", "createObjectFrom", "flattenObject", "guid", "insertIframe", "resolveURI", "sdk.api", "sdk.Auth", "sdk.Content", "sdk.Dialog", "sdk.DOM", "sdk.Event", "sdk.Extensions", "sdk.fbt", "sdk.feature", "sdk.Frictionless", "sdk.getContextType", "sdk.Impressions", "sdk.Native", "sdk.openMessenger", "sdk.RPC", "sdk.Runtime", "sdk.Scribe", "sdk.UA", "sdk.XD"], (function(a, b, c, d, e, f) {
                  ...
                  a = {
                      ...
                      "permissions.oauth": {
                          ...
                          transform: function(a) {
                              ...
                              var f = ES("Object", "keys", !1, ES("Object", "assign", !1, a.params.response_type ? b("createObjectFrom")(a.params.response_type.split(",")) : {}, {
                                  token: !0,
                                  signed_request: !0,
                                  graph_domain: !0
                              })).join(",");
                              a.params.display === "async" ? (ES("Object", "assign", !1, a.params, {
                                  ...
                                  response_type: f,
                                  domain: location.hostname
                              }), a.cb = b("sdk.Auth").xdResponseWrapper(c, b("sdk.Auth").getAuthResponse(), "permissions.oauth", a.params)) : (e && n._xdNextHandler(function(a) {
                                  c({
                                      authResponse: null,
                                      status: "not_authorized"
                                  })
                              }, d, a.params.plugin_prepare ? "opener.parent" : "opener", !0), ES("Object", "assign", !1, a.params, {
                                  client_id: b("sdk.Runtime").getClientID(),
                                  redirect_uri: b("resolveURI")(n.xdHandler(c, d, a.params.plugin_prepare ? "opener.parent" : "opener", b("sdk.Auth").getAuthResponse(), "permissions.oauth", !e, a.params)),
                                  origin: b("sdk.getContextType")(),
                                  response_type: f,
                                  domain: location.hostname
                              }));
                      ...
                      "auth.logout": {
                          transform: function(a) {
                              !b("sdk.Runtime").getClientID() ? b("Log").error("FB.logout() called before calling FB.init().") : !b("sdk.Auth").getAuthResponse() ? b("Log").error("FB.logout() called without an access token.") : b("sdk.Auth").logout(a.cb)
                          }
                      },
                      "login.status": {
                          transform: function(a) {
                  ...
                  var n = {
                      ...
                      popup: function(a) {
                          ...
                          if (!g) {
                              if (b("sdk.feature")("popup_blocker_scribe_logging", !0)) {
                                  i = h({
                                      method: a.name
                                  }) ? "POPUP_MAYBE_BLOCKED_OAUTH" : "POPUP_MAYBE_BLOCKED";
                                  b("sdk.Scribe").log("jssdk_error", {
                                      appId: b("sdk.Runtime").getClientID(),
                                      error: i,
                                      extra: {
                      ...
                      hidden: function(a) {
                          a.className = "FB_UI_Hidden", a.root = b("sdk.Content").appendHidden(document.createElement("div")), n._insertIframe(a)
                      },
                      iframe: function(a) {
              ...
              __d("legacy:fb.gamingservices", ["FB", "sdk.GamingServices"], (function(a, b, c, d, e, f) {
                  b("FB").provide("", {
                      gamingservices: b("sdk.GamingServices")
                  })
              }), 3);
              ...
              __d("legacy:fb.time", ["sdk.Event", "sdk.Time", "runOnce"], (function(a, b, c, d, e, f) {
                  ...
                  a.subscribe("iframeplugin:create", b("runOnce")(function() {
                      return b("sdk.Time").log("pluginframe")
                  }));
                  a.subscribe("iframeplugin:onload", b("runOnce")(function() {
              ...
              __d("IframePlugin", ["Log", "ObservableMixin", "QueryString", "Type", "UrlMap", "guid", "sdk.Auth", "sdk.createIframe", "sdk.DOM", "sdk.Event", "sdk.PlatformVersioning", "sdk.PluginUtils", "sdk.Runtime", "sdk.UA", "sdk.URI", "sdk.XD"], (function(a, b, c, d, e, f) {
                  var g = b("Type").extend({
                      constructor: function(a, c, d, e) {
                          ...
                          this.subscribe("xd.resize.flow", function(a) {
                              ES("Object", "assign", !1, f._iframeOptions.root.style, {
                                  ...
                                  overflow: ""
                              }), b("sdk.PluginUtils").resize(f._iframeOptions.root, b("sdk.PluginUtils").parse(a.width), b("sdk.PluginUtils").parse(a.height)), f.updateLift(), window.clearTimeout(f._timeoutID)
                          });
                          ...
                          this.subscribe("xd.resize.iframe", function(a) {
                              b("sdk.PluginUtils").resize(f._iframe, b("sdk.PluginUtils").parse(a.width), b("sdk.PluginUtils").parse(a.height)), f._isIframeResized = !0, f.updateLift(), window.clearTimeout(f._timeoutID)
                          });
                          ...
                          this._iframeOptions = {
                              ...
                              name: k,
                              width: this._config.mobile_fullsize && b("sdk.UA").mobile() ? void 0 : j.width || 1e3,
                              height: j.height || 1e3,
                              style: {
                                  border: "none",
                                  visibility: "hidden"
                      ...
                      process: function() {
                          ...
                          this.subscribe("render", function() {
                              b("sdk.Event").fire("iframeplugin:onload"), a._iframe.style.visibility = "visible", a._isIframeResized || b("sdk.PluginUtils").collapseIframe(a._iframe)
                          });
                          ...
                          this._timeoutID = window.setTimeout(function() {
                              b("sdk.PluginUtils").collapseIframe(a._iframe), b("Log").warn("%s:%s failed to resize in %ss", a._ns, a._tag, e)
                          }, e * 1e3);
              ...
              __d("sdk.XFBML.LoginButton", ["IframePlugin", "Log", "guid", "safeEval", "sdk.Auth", "sdk.Dialog", "sdk.ErrorHandling", "sdk.feature", "sdk.getContextType", "sdk.Impressions", "sdk.PluginUtils", "sdk.Runtime", "sdk.Scribe", "sdk.ui", "sdk.UIServer", "sdk.XD"], (function(a, b, c, d, e, f) {
                  var g = b("sdk.feature")("https_only_learn_more", "");
                  ...
                  function i(a, c, d) {
                      ...
                      e && (a.e2e = {});
                      e = function(a) {
                          f != null && b("sdk.XD").sendToFacebook(c, {
                  ...
                  a = b("IframePlugin").extend({
                      constructor: function(a, c, d, e) {
                          ...
                          var m = function(a) {
                              h(k, null, [a]), b("sdk.XD").sendToFacebook(l, {
                                  method: "loginReload",
                              ...
                              if (c.popup) {
                                  if (b("sdk.feature")("e2e_tracking", !0)) {
                                      ...
                                      a.subscribe("e2e:end", function(a) {
                                          a.method = c.call.params.method, a.display = c.call.params.display, b("Log").debug("e2e: %s", ES("JSON", "stringify", !1, a)), b("sdk.Impressions").log(114, {
                                              payload: a
                                          })
                                      })
                                  }
                              } else b("sdk.feature")("popup_blocker_scribe_logging", !0) && b("sdk.Scribe").log("jssdk_error", {
                                  appId: b("sdk.Runtime").getClientID(),
              ...
              __d("sdk.XFBML.Quote", ["DOMEventListener", "IframePlugin", "UnicodeUtils", "containsNode", "sdk.DOM", "sdk.feature", "sdk.UA", "sdk.XD"], (function(a, b, c, d, e, f) {
                  ...
                  function r(a) {
                      ...
                      (g || (g = b("UnicodeUtils"))).strlen(k) > c ? k = (g || (g = b("UnicodeUtils"))).substr(k, 0, c - 3) + "..." : k = (g || (g = b("UnicodeUtils"))).substr(k, 0, c);
                      if (!n && o) {
                          q(a).appendChild(o);
                          e = s(a);
                          o.style.left = e.x + "px";
                  ...
                  a = b("IframePlugin").extend({
                      constructor: function(a, c, d, e) {
                          ...
                          m = ES(ES("Array", "from", !1, document.getElementsByTagName("*")), "filter", !0, function(a) {
  ...
  new Image().src = "https:\/\/www.facebook.com\/" + 'common/scribe_endpoint.php?c=jssdk_error&m=' + encodeURIComponent('{"error":"LOAD", "extra": {"name":"' + e.name + '","line":"' + (e.lineNumber || e.line) + '","script":"' + (e.fileName || e.sourceURL || e.script) + '","stack":"' + (e.stackTrace || e.stack) + '","revision":"1002513418","namespace":"FB","message":"' + e.message + '"}}');
}